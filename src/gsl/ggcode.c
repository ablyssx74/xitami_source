/*===========================================================================
 *                                                                           
 *  ggcode.c    GSLgen code generator                                      
 *                                                                           
 *  Written:    1998/03/30    iMatix <tools@imatix.com>                        
 *  Revised:    2000/02/15
 *                                                                           
    ...
    switch (type)
      {
        ...
        case GG_END_TEMPLATE: pop_control (control);
                              if (control-> type != CTL_TEMPLATE)
                                  ...
                                  cur_script_block.template = (int) control-> extra;
                              break;
        default:              break;
      }
    if (error)
...
MODULE push_template_control (void)
{
    ...
    push_control (CTL_TEMPLATE, (void *) cur_script_block.template);
