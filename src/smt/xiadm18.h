...
#define XIADM18_MESSAGE_TO_USER             0
#define XIADM18_L_DIR_NAME                  1
#define XIADM18_L_DIR_PATH                  2
#define XIADM18_L_DIR_USERS                 3
#define XIADM18_DIR_NAME                    4
#define XIADM18_DIR_PATH                    5
#define XIADM18_DIR_USERS                   6
#define XIADM18_L_NEW_DIR                   7
#define XIADM18_NEW_DIR                     8
#define XIADM18_FTP_DIR_LIST                9
...
static byte xiadm18_blocks [] = {
    ...
    0, 29, 10, 6, 1, 0, 0, 15, 0, 15, 'f', '2', '6', '5', 0, 'D', 'i',
    ...
    0, 30, 10, 6, 1, 0, 0, 16, 0, 16, 'f', '2', '6', '6', 0, 'T', 'r',
    ...
    0, 20, 10, 6, 1, 0, 0, 6, 0, 6, 'f', '2', '6', '7', 0, 'U', 's',
    'e', 'r', 's', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 8, 29,
    ...
    10,
    /*  !--FIELD TEXTUAL f268 NAME=d ... =40 MAX=80 UPPER=0 VALUE=""         */
    0, 14, 10, 10, 15, 0, 0, '(', 0, 'P', 'f', '2', '6', '8', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 140,
    /*  !--FIELD TEXTUAL f269 NAME=d ... E=60 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 6, 15, 0, 0, '<', 0, '<', 'f', '2', '6', '9', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 8, 186,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 140,
    /*  !--FIELD NUMERIC f270 NAME=d ... MMA=0 SIZE=5 MAX=? VALUE=""         */
    0, 19, 11, 6, 15, 0, 5, 0, 5, 0, 0, 0, 0, 0, 0, 'f', '2', '7', '0',
    0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 8, 186,
    /*  </TR>                                                                */
    ...
    0, 44, 10, 6, 1, 0, 0, 30, 0, 30, 'f', '2', '7', '1', 0, 'A', 'd',
    ...
    '"', '"', '8', '0', '%', '"', '"', '>', 10,
    /*  !--FIELD TEXTUAL f272 NAME=n ... =40 MAX=80 UPPER=0 VALUE=""         */
    0, 14, 10, 0, 1, 0, 0, '(', 0, 'P', 'f', '2', '7', '2', 0, 0,
    ...
    0, 29, 11, 5, 1, 0, 4, 0, 4, 0, 0, 0, 0, 0, 0, 'f', 't', 'p', '_',
    'd', 'i', 'r', '_', 'l', 'i', 's', 't', 0, '1', '5', 0,
    /*  </FORM>                                                              */
    0, 9, 0, '<', '/', 'F', 'O', 'R', 'M', '>', 10,
    /*  <HR>                                                                 */
    0, 6, 0, '<', 'H', 'R', '>', 10,
...
static FIELD_DEFN xiadm18_fields [] = {
    ...
    { 82, 2046, 15 },                   /*  l_dir_name                      */
    { 99, 2092, 16 },                   /*  l_dir_path                      */
    { 117, 2136, 6 },                   /*  l_dir_users                     */
    { 125, 2218, 80 },                  /*  dir_name                        */
    { 1355, 2249, 60 },                 /*  dir_path                        */
    { 2285, 2277, 5 },                  /*  dir_users                       */
    { 2390, 2381, 30 },                 /*  l_new_dir                       */
    { 2422, 2465, 80 },                 /*  new_dir                         */
    { 2504, 2534, 4 },                  /*  ftp_dir_list                    */
    { 2510, 0, 0 },                     /*  -- sentinel --                  */
    };
