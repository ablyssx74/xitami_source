/*---------------------------------------------------------------------------
 *  xiadm15.h - HTML form definition
 *
 *  Generated 2000/04/21, 21:31:23 by fxgen 2.0
 *  See Studio on-line help pages at <http://www.imatix.com>.
 *---------------------------------------------------------------------------*/

#ifndef __FORM_XIADM15__
#define __FORM_XIADM15__
...
#define WSX_LIST_MAX                        15
#define XIADM15_MESSAGE_TO_USER             0
#define XIADM15_L_WSX_ALIAS                 1
#define XIADM15_L_WSX_AGENT                 2
#define XIADM15_KEY                         3
#define XIADM15_WSX_ALIAS                   4
#define XIADM15_WSX_AGENT                   5
#define XIADM15_WSX_LIST                    6

/*  This table contains each block in the form                               */

static byte xiadm15_blocks [] = {
    /*  <HTML>                                                               */
    0, 8, 0, '<', 'H', 'T', 'M', 'L', '>', 10,
    ...
    'E', '>', 10,
    /*  <TD ALIGN=CENTER><FONT SIZE= ... tension (WSX) Agents </FONT>        */
    0, 86, 0, '<', 'T', 'D', 32, 'A', 'L', 'I', 'G', 'N', '=', 'C', 'E',
    'N', 'T', 'E', 'R', '>', '<', 'F', 'O', 'N', 'T', 32, 'S', 'I', 'Z',
    'E', '=', '+', '1', '>', '#', '(', 'c', 'o', 'n', 'f', 'i', 'g',
    ')', 32, 45, 32, 'W', 'e', 'b', 45, 'S', 'e', 'r', 'v', 'e', 'r',
    32, 'E', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 32, '(', 'W', 'S',
    'X', ')', 32, 'A', 'g', 'e', 'n', 't', 's', 32, '<', '/', 'F', 'O',
    'N', 'T', '>', 10,
    /*  <TD ALIGN=RIGHT>                                                     */
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f203 NAME=L_wsx-alias VALUE="URL alias:"            */
    0, 24, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '2', '0', '3', 0, 'U', 'R',
    'L', 32, 'a', 'l', 'i', 'a', 's', ':', 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 8, 'u',
    /*  !--FIELD TEXTUAL f204 NAME=L ... ent VALUE="WSX agent name:"         */
    0, 29, 10, 6, 1, 0, 0, 15, 0, 15, 'f', '2', '0', '4', 0, 'W', 'S',
    'X', 32, 'a', 'g', 'e', 'n', 't', 32, 'n', 'a', 'm', 'e', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 8, 175,
    /*  !--REPEAT wsx_list  ROWS=15                                          */
    0, 7, 4, 0, 6, 0, 12, 0, 15,
    /*  </TR>                                                                */
    0, 7, 0, '<', '/', 'T', 'R', '>', 10,
    /*  <TR>                                                                 */
    ...
    10,
    /*  !--FIELD TEXTUAL f205 NAME=key SIZE=20 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 4, 15, 0, 0, 20, 0, 20, 'f', '2', '0', '5', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 251,
    /*  !--FIELD TEXTUAL f206 NAME=w ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, 20, 0, 20, 'f', '2', '0', '6', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, ')',
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 251,
    /*  !--FIELD TEXTUAL f207 NAME=w ... E=40 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, '(', 0, '(', 'f', '2', '0', '7', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, ')',
    /*  </TR>                                                                */
    0, 4, 1, 0, 8, 236,
    /*  </TABLE>                                                             */
    0, 4, 1, 0, 7, '%',
    /*  !--FIELD NUMERIC wsx_list SIZE=4 VALUE=15                            */
    0, 25, 11, 5, 1, 0, 4, 0, 4, 0, 0, 0, 0, 0, 0, 'w', 's', 'x', '_',
    'l', 'i', 's', 't', 0, '1', '5', 0,
    /*  </FORM>                                                              */
    0, 9, 0, '<', '/', 'F', 'O', 'R', 'M', '>', 10,
    /*  <HR>                                                                 */
...
static FIELD_DEFN xiadm15_fields [] = {
    { 0, 1927, 80 },                    /*  message_to_user                 */
    { 82, 2197, 10 },                   /*  l_wsx_alias                     */
    { 94, 2238, 15 },                   /*  l_wsx_agent                     */
    { 111, 2329, 20 },                  /*  key                             */
    { 441, 2360, 20 },                  /*  wsx_alias                       */
    { 771, 2388, 40 },                  /*  wsx_agent                       */
    { 1401, 2422, 4 },                  /*  wsx_list                        */
    { 1407, 0, 0 },                     /*  -- sentinel --                  */
    };
...
typedef struct {
    ...
    byte   l_wsx_alias_a        ;
    char   l_wsx_alias          [10 + 1];
    byte   l_wsx_agent_a        ;
    char   l_wsx_agent          [15 + 1];
    byte   key_a                [15] ;
    char   key                  [15] [20 + 1];
    byte   wsx_alias_a          [15] ;
    char   wsx_alias            [15] [20 + 1];
    byte   wsx_agent_a          [15] ;
    char   wsx_agent            [15] [40 + 1];
    byte   wsx_list_a           ;
    char   wsx_list             [4 + 1];
    byte   back_a;
    byte   save_a;
