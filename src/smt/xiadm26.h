...
static byte xiadm26_blocks [] = {
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f360 NAME=L ... ias-name VALUE="FTP alias:"         */
    0, 24, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '3', '6', '0', 0, 'F', 'T',
    'P', 32, 'a', 'l', 'i', 'a', 's', ':', 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 8, 'e',
    /*  !--FIELD TEXTUAL f361 NAME=L ... ath VALUE="Points to path:"         */
    0, 29, 10, 6, 1, 0, 0, 15, 0, 15, 'f', '3', '6', '1', 0, 'P', 'o',
    'i', 'n', 't', 's', 32, 't', 'o', 32, 'p', 'a', 't', 'h', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 8, 159,
    /*  !--REPEAT ftp_alias_list  ROWS=15                                    */
    0, 7, 4, 0, 6, 0, 12, 0, 15,
    /*  </TR>                                                                */
    0, 7, 0, '<', '/', 'T', 'R', '>', 10,
    /*  <TR>                                                                 */
    ...
    10,
    /*  !--FIELD TEXTUAL f362 NAME=key SIZE=20 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 4, 15, 0, 0, 20, 0, 20, 'f', '3', '6', '2', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 235,
    /*  !--FIELD TEXTUAL f363 NAME=f ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, 20, 0, 20, 'f', '3', '6', '3', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, 25,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 235,
    /*  !--FIELD TEXTUAL f364 NAME=f ... =50 MAX=80 UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, '2', 0, 'P', 'f', '3', '6', '4', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, 25,
    /*  </TR>                                                                */
    0, 4, 1, 0, 8, 220,
    /*  </TABLE>                                                             */
    0, 4, 1, 0, 7, 21,
    /*  !--FIELD NUMERIC ftp_alias_list SIZE=4 VALUE=15                      */
...
static FIELD_DEFN xiadm26_fields [] = {
    ...
    { 82, 2181, 10 },                   /*  l_ftp_alias_name                */
    { 94, 2222, 15 },                   /*  l_ftp_alias_path                */
    { 111, 2313, 20 },                  /*  key                             */
    { 441, 2344, 20 },                  /*  ftp_alias_name                  */
    { 771, 2372, 80 },                  /*  ftp_alias_path                  */
    { 2001, 2406, 4 },                  /*  ftp_alias_list                  */
    { 2007, 0, 0 },                     /*  -- sentinel --                  */
    };
...
typedef struct {
    ...
    byte   key_a                [15] ;
    char   key                  [15] [20 + 1];
    byte   ftp_alias_name_a     [15] ;
    char   ftp_alias_name       [15] [20 + 1];
    byte   ftp_alias_path_a     [15] ;
    char   ftp_alias_path       [15] [80 + 1];
