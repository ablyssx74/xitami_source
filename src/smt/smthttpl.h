/*  ----------------------------------------------------------------<Prolog>-
    ...
    Written:    1996/04/26  iMatix SMT kernel team <smt@imatix.com>
    Revised:    2000/04/18
...
Bool    http_modified_since        (HTTP_CONTEXT *, char *filename,
                                    char *header);
Bool    http_unmodified_since      (HTTP_CONTEXT *, char *filename,
                                    char *header);
