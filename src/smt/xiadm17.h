...
static byte xiadm17_blocks [] = {
    ...
    halt_event & 255), 0, 8, 0, 0, 39, 0, '(', 'h', 'a', 'l', 't', 0,
    '/', 'a', 'd', 'm', 'i', 'n', '/', '$', 'h', 'a', 'l', 't', '.',
    ...
    exit_event & 255), 0, 10, 0, 0, 39, 0, '(', 'e', 'x', 'i', 't', 0,
    '/', 'a', 'd', 'm', 'i', 'n', '/', '$', 'e', 'x', 'i', 't', '.',
    ...
    0, 24, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '2', '5', '3', 0, 'U', 's',
    'e', 'r', 32, 'n', 'a', 'm', 'e', ':', 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    ...
    0, 23, 10, 6, 1, 0, 0, 9, 0, 9, 'f', '2', '5', '4', 0, 'P', 'a',
    's', 's', 'w', 'o', 'r', 'd', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 8, 178,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    ...
    0, 30, 10, 6, 1, 0, 0, 16, 0, 16, 'f', '2', '5', '5', 0, 'L', 'o',
    ...
    0, 26, 10, 6, 1, 0, 0, 12, 0, 12, 'f', '2', '5', '6', 0, 'P', 'e',
    'r', 'm', 'i', 's', 's', 'i', 'o', 'n', 's', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 8, 178,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    ...
    0, 30, 10, 6, 1, 0, 0, 16, 0, 16, 'f', '2', '5', '7', 0, 'S', 'p',
    ...
    0, 30, 10, 6, 1, 0, 0, 16, 0, 16, 'f', '2', '5', '8', 0, 'N', 'u',
    'm', 'b', 'e', 'r', 32, 'o', 'f', 32, 'f', 'i', 'l', 'e', 's', ':',
    0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 8, 178,
    /*  !--REPEAT ftp_user_list  ROWS=15                                     */
    0, 7, 4, 0, 13, 0, 21, 0, 15,
    /*  </TR>                                                                */
    0, 7, 0, '<', '/', 'T', 'R', '>', 10,
    /*  <TR>                                                                 */
    0, 4, 1, 0, 8, 'p',
    ...
    10,
    /*  !--FIELD TEXTUAL f259 NAME=u ... E=40 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 10, 15, 0, 0, '(', 0, '(', 'f', '2', '5', '9', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 9, 164,
    /*  !--FIELD TEXTUAL f260 NAME=p ... E=40 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 6, 15, 0, 0, '(', 0, '(', 'f', '2', '6', '0', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, 210,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 9, 164,
    /*  !--FIELD TEXTUAL f261 NAME=r ... E=50 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 6, 15, 0, 0, '2', 0, '2', 'f', '2', '6', '1', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, 210,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 9, 164,
    /*  !--FIELD TEXTUAL f262 NAME=a ... ZE=6 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 6, 15, 0, 0, 6, 0, 6, 'f', '2', '6', '2', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, 210,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 9, 164,
    /*  !--FIELD NUMERIC f263 NAME=c ... MA=0 SIZE=15 MAX=? VALUE=""         */
    0, 19, 11, 6, 15, 0, 15, 0, 15, 3, 0, 2, 0, 0, 0, 'f', '2', '6',
    '3', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, 210,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 9, 164,
    /*  !--FIELD NUMERIC f264 NAME=c ... MMA=0 SIZE=7 MAX=? VALUE=""         */
    0, 19, 11, 6, 15, 0, 7, 0, 7, 0, 0, 0, 0, 0, 0, 'f', '2', '6', '4',
    0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, 210,
    /*  </TR>                                                                */
...
static FIELD_DEFN xiadm17_fields [] = {
    { 0, 1968, 80 },                    /*  message_to_user                 */
    { 82, 2200, 10 },                   /*  l_user_name                     */
    { 94, 2241, 9 },                    /*  l_password                      */
    { 105, 2278, 16 },                  /*  l_rootdir                       */
    { 123, 2322, 12 },                  /*  l_access                        */
    { 137, 2362, 16 },                  /*  l_cur_usage                     */
    { 155, 2406, 16 },                  /*  l_cur_files                     */
    { 173, 2498, 40 },                  /*  user_name                       */
    { 803, 2529, 40 },                  /*  password                        */
    { 1433, 2557, 50 },                 /*  rootdir                         */
    { 2213, 2585, 6 },                  /*  access                          */
    { 2333, 2613, 15 },                 /*  cur_usage                       */
    { 2588, 2646, 7 },                  /*  cur_files                       */
    { 2723, 2685, 4 },                  /*  ftp_user_list                   */
    { 2729, 0, 0 },                     /*  -- sentinel --                  */
    };
