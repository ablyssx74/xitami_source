/*---------------------------------------------------------------------------
 *  xiadm20.h - HTML form definition
 *
 *  Generated 2000/04/21, 21:31:23 by fxgen 2.0
 *  See Studio on-line help pages at <http://www.imatix.com>.
 *---------------------------------------------------------------------------*/

#ifndef __FORM_XIADM20__
#define __FORM_XIADM20__
...
#define FILTER_LIST_MAX                     15
#define XIADM20_MESSAGE_TO_USER             0
#define XIADM20_L_FILTER_ALIAS              1
#define XIADM20_L_FILTER_AGENT              2
#define XIADM20_KEY                         3
#define XIADM20_FILTER_ALIAS                4
#define XIADM20_FILTER_AGENT                5
#define XIADM20_FILTER_LIST                 6

/*  This table contains each block in the form                               */

static byte xiadm20_blocks [] = {
    /*  <HTML>                                                               */
    0, 8, 0, '<', 'H', 'T', 'M', 'L', '>', 10,
    ...
    'E', '>', 10,
    /*  <TD ALIGN=CENTER><FONT SIZE=+1>#(config) - Filters </FONT>           */
    0, 60, 0, '<', 'T', 'D', 32, 'A', 'L', 'I', 'G', 'N', '=', 'C', 'E',
    'N', 'T', 'E', 'R', '>', '<', 'F', 'O', 'N', 'T', 32, 'S', 'I', 'Z',
    'E', '=', '+', '1', '>', '#', '(', 'c', 'o', 'n', 'f', 'i', 'g',
    ')', 32, 45, 32, 'F', 'i', 'l', 't', 'e', 'r', 's', 32, '<', '/',
    'F', 'O', 'N', 'T', '>', 10,
    /*  <TD ALIGN=RIGHT>                                                     */
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f278 NAME=L ... UE="File extension (.xxx):"         */
    0, 36, 10, 6, 1, 0, 0, 22, 0, 22, 'f', '2', '7', '8', 0, 'F', 'i',
    'l', 'e', 32, 'e', 'x', 't', 'e', 'n', 's', 'i', 'o', 'n', 32, '(',
    '.', 'x', 'x', 'x', ')', ':', 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 8, '^',
    /*  !--FIELD TEXTUAL f279 NAME=L ... "Filter command or script:"         */
    0, 39, 10, 6, 1, 0, 0, 25, 0, 25, 'f', '2', '7', '9', 0, 'F', 'i',
    'l', 't', 'e', 'r', 32, 'c', 'o', 'm', 'm', 'a', 'n', 'd', 32, 'o',
    'r', 32, 's', 'c', 'r', 'i', 'p', 't', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 8, 164,
    /*  !--REPEAT filter_list  ROWS=15                                       */
    0, 7, 4, 0, 6, 0, 12, 0, 15,
    /*  </TR>                                                                */
    0, 7, 0, '<', '/', 'T', 'R', '>', 10,
    /*  <TR>                                                                 */
    ...
    10,
    /*  !--FIELD TEXTUAL f280 NAME=key SIZE=10 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 4, 15, 0, 0, 10, 0, 10, 'f', '2', '8', '0', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 250,
    /*  !--FIELD TEXTUAL f281 NAME=f ... E=10 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, 10, 0, 10, 'f', '2', '8', '1', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, '(',
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 250,
    /*  !--FIELD TEXTUAL f282 NAME=f ... E=50 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, '2', 0, '2', 'f', '2', '8', '2', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, '(',
    /*  </TR>                                                                */
    0, 4, 1, 0, 8, 235,
    /*  </TABLE>                                                             */
    0, 4, 1, 0, 7, 14,
    /*  !--FIELD NUMERIC filter_list SIZE=4 VALUE=15                         */
    0, 28, 11, 5, 1, 0, 4, 0, 4, 0, 0, 0, 0, 0, 0, 'f', 'i', 'l', 't',
    'e', 'r', '_', 'l', 'i', 's', 't', 0, '1', '5', 0,
    /*  </FORM>                                                              */
    0, 9, 0, '<', '/', 'F', 'O', 'R', 'M', '>', 10,
    /*  <HR>                                                                 */
    0, 6, 0, '<', 'H', 'R', '>', 10,
...
static FIELD_DEFN xiadm20_fields [] = {
    { 0, 1904, 80 },                    /*  message_to_user                 */
    { 82, 2174, 22 },                   /*  l_filter_alias                  */
    { 106, 2227, 25 },                  /*  l_filter_agent                  */
    { 133, 2328, 10 },                  /*  key                             */
    { 313, 2359, 10 },                  /*  filter_alias                    */
    { 493, 2387, 50 },                  /*  filter_agent                    */
    { 1273, 2421, 4 },                  /*  filter_list                     */
    { 1279, 0, 0 },                     /*  -- sentinel --                  */
    };
...
typedef struct {
    ...
    byte   l_filter_alias_a     ;
    char   l_filter_alias       [22 + 1];
    byte   l_filter_agent_a     ;
    char   l_filter_agent       [25 + 1];
    byte   key_a                [15] ;
    char   key                  [15] [10 + 1];
    byte   filter_alias_a       [15] ;
    char   filter_alias         [15] [10 + 1];
    byte   filter_agent_a       [15] ;
    char   filter_agent         [15] [50 + 1];
    byte   filter_list_a        ;
    char   filter_list          [4 + 1];
    byte   back_a;
    byte   save_a;
    byte   clear_a;
    byte   undo_a;
