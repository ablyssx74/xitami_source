...
static byte xiadm11_blocks [] = {
    ...
    0, 23, 10, 6, 1, 0, 0, 9, 0, 9, 'f', '1', '7', '6', 0, 'V', 'a',
    'r', 'i', 'a', 'b', 'l', 'e', ':', 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    ...
    0, 29, 10, 6, 1, 0, 0, 15, 0, 15, 'f', '1', '7', '7', 0, 'H', 'a',
    ...
    10,
    /*  !--FIELD TEXTUAL f178 NAME=key SIZE=20 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 4, 15, 0, 0, 20, 0, 20, 'f', '1', '7', '8', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 253,
    /*  !--FIELD TEXTUAL f179 NAME=c ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, 20, 0, 20, 'f', '1', '7', '9', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, '+',
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 253,
    /*  !--FIELD TEXTUAL f180 NAME=c ... 40 MAX=120 UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, '(', 0, 'x', 'f', '1', '8', '0', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, '+',
    /*  </TR>                                                                */
    0, 4, 1, 0, 8, 238,
...
static FIELD_DEFN xiadm11_fields [] = {
    { 0, 1930, 80 },                    /*  message_to_user                 */
    { 82, 2200, 9 },                    /*  l_cgi_envir_name                */
    { 93, 2240, 15 },                   /*  l_cgi_envir_value               */
    { 110, 2331, 20 },                  /*  key                             */
    { 440, 2362, 20 },                  /*  cgi_envir_name                  */
    { 770, 2390, 120 },                 /*  cgi_envir_value                 */
    { 2600, 2424, 4 },                  /*  cgi_envir_list                  */
    { 2606, 0, 0 },                     /*  -- sentinel --                  */
    };
