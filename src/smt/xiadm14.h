/*---------------------------------------------------------------------------
 *  xiadm14.h - HTML form definition
 *
 *  Generated 2000/04/21, 21:31:23 by fxgen 2.0
 *  See Studio on-line help pages at <http://www.imatix.com>.
 *---------------------------------------------------------------------------*/

#ifndef __FORM_XIADM14__
#define __FORM_XIADM14__
...
#define CGI_ALIAS_LIST_MAX                  15
#define XIADM14_MESSAGE_TO_USER             0
#define XIADM14_L_CGI_ALIAS_NAME            1
#define XIADM14_L_CGI_ALIAS_PATH            2
#define XIADM14_KEY                         3
#define XIADM14_CGI_ALIAS_NAME              4
#define XIADM14_CGI_ALIAS_PATH              5
#define XIADM14_CGI_ALIAS_LIST              6

/*  This table contains each block in the form                               */

static byte xiadm14_blocks [] = {
    /*  <HTML>                                                               */
    0, 8, 0, '<', 'H', 'T', 'M', 'L', '>', 10,
    ...
    'E', '>', 10,
    /*  <TD ALIGN=CENTER><FONT SIZE=+1>#(config) - CGI Aliases </FONT>       */
    0, 64, 0, '<', 'T', 'D', 32, 'A', 'L', 'I', 'G', 'N', '=', 'C', 'E',
    'N', 'T', 'E', 'R', '>', '<', 'F', 'O', 'N', 'T', 32, 'S', 'I', 'Z',
    'E', '=', '+', '1', '>', '#', '(', 'c', 'o', 'n', 'f', 'i', 'g',
    ')', 32, 45, 32, 'C', 'G', 'I', 32, 'A', 'l', 'i', 'a', 's', 'e',
    's', 32, '<', '/', 'F', 'O', 'N', 'T', '>', 10,
    /*  <TD ALIGN=RIGHT>                                                     */
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f198 NAME=L ... ias-name VALUE="CGI alias:"         */
    0, 24, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '1', '9', '8', 0, 'C', 'G',
    'I', 32, 'a', 'l', 'i', 'a', 's', ':', 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 8, 'e',
    /*  !--FIELD TEXTUAL f199 NAME=L ... ath VALUE="Points to path:"         */
    0, 29, 10, 6, 1, 0, 0, 15, 0, 15, 'f', '1', '9', '9', 0, 'P', 'o',
    'i', 'n', 't', 's', 32, 't', 'o', 32, 'p', 'a', 't', 'h', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 8, 159,
    /*  !--REPEAT cgi_alias_list  ROWS=15                                    */
    0, 7, 4, 0, 6, 0, 12, 0, 15,
    /*  </TR>                                                                */
    0, 7, 0, '<', '/', 'T', 'R', '>', 10,
    /*  <TR>                                                                 */
    ...
    10,
    /*  !--FIELD TEXTUAL f200 NAME=key SIZE=20 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 4, 15, 0, 0, 20, 0, 20, 'f', '2', '0', '0', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 235,
    /*  !--FIELD TEXTUAL f201 NAME=c ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, 20, 0, 20, 'f', '2', '0', '1', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, 25,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 8, 235,
    /*  !--FIELD TEXTUAL f202 NAME=c ... =50 MAX=80 UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, '2', 0, 'P', 'f', '2', '0', '2', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, 25,
    /*  </TR>                                                                */
    0, 4, 1, 0, 8, 220,
    /*  </TABLE>                                                             */
    0, 4, 1, 0, 7, 21,
    /*  !--FIELD NUMERIC cgi_alias_list SIZE=4 VALUE=15                      */
    0, 31, 11, 5, 1, 0, 4, 0, 4, 0, 0, 0, 0, 0, 0, 'c', 'g', 'i', '_',
    'a', 'l', 'i', 'a', 's', '_', 'l', 'i', 's', 't', 0, '1', '5', 0,
    /*  </FORM>                                                              */
    0, 9, 0, '<', '/', 'F', 'O', 'R', 'M', '>', 10,
    /*  <HR>                                                                 */
    0, 6, 0, '<', 'H', 'R', '>', 10,
...
static FIELD_DEFN xiadm14_fields [] = {
    { 0, 1911, 80 },                    /*  message_to_user                 */
    { 82, 2181, 10 },                   /*  l_cgi_alias_name                */
    { 94, 2222, 15 },                   /*  l_cgi_alias_path                */
    { 111, 2313, 20 },                  /*  key                             */
    { 441, 2344, 20 },                  /*  cgi_alias_name                  */
    { 771, 2372, 80 },                  /*  cgi_alias_path                  */
    { 2001, 2406, 4 },                  /*  cgi_alias_list                  */
    { 2007, 0, 0 },                     /*  -- sentinel --                  */
    };
...
typedef struct {
    ...
    byte   l_cgi_alias_name_a   ;
    char   l_cgi_alias_name     [10 + 1];
    byte   l_cgi_alias_path_a   ;
    char   l_cgi_alias_path     [15 + 1];
    byte   key_a                [15] ;
    char   key                  [15] [20 + 1];
    byte   cgi_alias_name_a     [15] ;
    char   cgi_alias_name       [15] [20 + 1];
    byte   cgi_alias_path_a     [15] ;
    char   cgi_alias_path       [15] [80 + 1];
    byte   cgi_alias_list_a     ;
    char   cgi_alias_list       [4 + 1];
    byte   back_a;
    byte   save_a;
    byte   clear_a;
    byte   undo_a;
...
static FORM_DEFN form_xiadm14 = {
    xiadm14_blocks,
    xiadm14_fields,
    75,                                 /*  Number of blocks in form        */
    7,                                  /*  Number of fields in form        */
    12,                                 /*  Number of actions in form       */
    2007,                               /*  Size of fields                  */
    "xiadm14",                          /*  Name of form                    */
    };
