...
static byte xiadm01_blocks [] = {
    ...
    0, 60, 20, 2, 1, (byte) ((word) config_event / 256), (byte) ((word)
    ...
    0, 60, 20, 2, 1, (byte) ((word) wizard_event / 256), (byte) ((word)
    ...
    'a', 'n', 'd', 10,
    /*  higher browsers, including M ... the WBA Console Preferences.        */
    0, 222, 0, 'h', 'i', 'g', 'h', 'e', 'r', 32, 'b', 'r', 'o', 'w',
    's', 'e', 'r', 's', ',', 32, 'i', 'n', 'c', 'l', 'u', 'd', 'i', 'n',
    'g', 32, 'M', 'S', 'I', 'E', ',', 32, 'N', 'e', 't', 's', 'c', 'a',
    'p', 'e', 32, 'N', 'a', 'v', 'i', 'g', 'a', 't', 'o', 'r', 32, 'a',
    'n', 'd', 32, 'O', 'p', 'e', 'r', 'a', '.', 32, 32, 'B', 'y', 32,
    'd', 'e', 'f', 'a', 'u', 'l', 't', 10, 10, 't', 'h', 'e', 32, 'W',
    'B', 'A', 32, 'u', 's', 'e', 's', 32, 'J', 'a', 'v', 'a', 'S', 'c',
    'r', 'i', 'p', 't', ',', 32, 's', 'o', 32, 'm', 'a', 'k', 'e', 32,
    's', 'u', 'r', 'e', 32, 'i', 't', 39, 's', 32, 'e', 'n', 'a', 'b',
    'l', 'e', 'd', 32, 'i', 'n', 32, 'y', 'o', 'u', 'r', 32, 'b', 'r',
    'o', 'w', 's', 'e', 'r', '.', 32, 32, 'I', 'f', 32, 'y', 'o', 'u',
    10, 10, 'd', 'o', 32, 'n', 'o', 't', 32, 'a', 'l', 'l', 'o', 'w',
    32, 'J', 'a', 'v', 'a', 'S', 'c', 'r', 'i', 'p', 't', ',', 32, 'd',
    'i', 's', 'a', 'b', 'l', 'e', 32, 'i', 't', 32, 'i', 'n', 32, 't',
    'h', 'e', 32, 'W', 'B', 'A', 32, 'C', 'o', 'n', 's', 'o', 'l', 'e',
    32, 'P', 'r', 'e', 'f', 'e', 'r', 'e', 'n', 'c', 'e', 's', '.', 10,
