/*---------------------------------------------------------------------------
 *  xiadm13.h - HTML form definition
 *
 *  Generated 2000/04/21, 21:31:23 by fxgen 2.0
 *  See Studio on-line help pages at <http://www.imatix.com>.
 *---------------------------------------------------------------------------*/

#ifndef __FORM_XIADM13__
#define __FORM_XIADM13__
...
#define USER_LIST_MAX                       15
#define XIADM13_MESSAGE_TO_USER             0
#define XIADM13_L_USER_NAME                 1
#define XIADM13_L_PASSWORD                  2
#define XIADM13_KEY                         3
#define XIADM13_USER_NAME                   4
#define XIADM13_PASSWORD                    5
#define XIADM13_USER_LIST                   6

/*  This table contains each block in the form                               */

static byte xiadm13_blocks [] = {
    /*  <HTML>                                                               */
    0, 8, 0, '<', 'H', 'T', 'M', 'L', '>', 10,
    ...
    'E', '>', 10,
    /*  <TD ALIGN=CENTER><FONT SIZE= ... access this resource </FONT>        */
    0, 87, 0, '<', 'T', 'D', 32, 'A', 'L', 'I', 'G', 'N', '=', 'C', 'E',
    'N', 'T', 'E', 'R', '>', '<', 'F', 'O', 'N', 'T', 32, 'S', 'I', 'Z',
    'E', '=', '+', '1', '>', '#', '(', 'c', 'o', 'n', 'f', 'i', 'g',
    ')', 32, 45, 32, 'U', 's', 'e', 'r', 's', 32, 'w', 'h', 'o', 32,
    'c', 'a', 'n', 32, 'a', 'c', 'c', 'e', 's', 's', 32, 't', 'h', 'i',
    's', 32, 'r', 'e', 's', 'o', 'u', 'r', 'c', 'e', 32, '<', '/', 'F',
    'O', 'N', 'T', '>', 10,
    /*  <TD ALIGN=RIGHT>                                                     */
    ...
    'N', 'T', 'E', 'R', 32, 'V', 'A', 'L', 'I', 'G', 'N', '=', 'T', 'O',
    'P', '>', 10,
    /*  !--FIELD TEXTUAL f193 NAME=L_user-name VALUE="User name:"            */
    0, 24, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '1', '9', '3', 0, 'U', 's',
    'e', 'r', 32, 'n', 'a', 'm', 'e', ':', 0,
    /*  </TH>                                                                */
    0, 7, 0, '<', '/', 'T', 'H', '>', 10,
    /*  <TH ALIGN=CENTER VALIGN=TOP>                                         */
    0, 4, 1, 0, 8, 130,
    /*  !--FIELD TEXTUAL f194 NAME=L_password VALUE="Password:"              */
    0, 23, 10, 6, 1, 0, 0, 9, 0, 9, 'f', '1', '9', '4', 0, 'P', 'a',
    's', 's', 'w', 'o', 'r', 'd', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 8, 188,
    /*  !--REPEAT user_list  ROWS=15                                         */
    0, 7, 4, 0, 6, 0, 12, 0, 15,
    /*  </TR>                                                                */
    0, 7, 0, '<', '/', 'T', 'R', '>', 10,
    /*  <TR>                                                                 */
    ...
    10,
    /*  !--FIELD TEXTUAL f195 NAME=key SIZE=20 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 4, 15, 0, 0, 20, 0, 20, 'f', '1', '9', '5', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 9, 2,
    /*  !--FIELD TEXTUAL f196 NAME=u ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, 20, 0, 20, 'f', '1', '9', '6', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, '0',
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 9, 2,
    /*  !--FIELD TEXTUAL f197 NAME=p ... E=20 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, 20, 0, 20, 'f', '1', '9', '7', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, '0',
    /*  </TR>                                                                */
    0, 4, 1, 0, 8, 243,
    /*  </TABLE>                                                             */
    0, 4, 1, 0, 7, '2',
    /*  !--FIELD NUMERIC user_list SIZE=4 VALUE=15                           */
    0, 26, 11, 5, 1, 0, 4, 0, 4, 0, 0, 0, 0, 0, 0, 'u', 's', 'e', 'r',
    '_', 'l', 'i', 's', 't', 0, '1', '5', 0,
    /*  </FORM>                                                              */
    0, 9, 0, '<', '/', 'F', 'O', 'R', 'M', '>', 10,
    /*  <HR>                                                                 */
...
static FIELD_DEFN xiadm13_fields [] = {
    { 0, 1940, 80 },                    /*  message_to_user                 */
    { 82, 2210, 10 },                   /*  l_user_name                     */
    { 94, 2251, 9 },                    /*  l_password                      */
    { 105, 2336, 20 },                  /*  key                             */
    { 435, 2367, 20 },                  /*  user_name                       */
    { 765, 2395, 20 },                  /*  password                        */
    { 1095, 2429, 4 },                  /*  user_list                       */
    { 1101, 0, 0 },                     /*  -- sentinel --                  */
    };
