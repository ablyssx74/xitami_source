/*  ----------------------------------------------------------------<Prolog>-
    ...
    Generated:  2000/04/02 from ximodel.gsl, using GSLgen.
...
#define SERVER_NAME                                                         \
    "Xitami/Lite Web Server v" CUR_VERSION " (c) 1991-2000 iMatix"

#define COPYRIGHT                                                           \
    SERVER_NAME "\n"                                                        \
    "Xitami/Lite is free software and comes with ABSOLUTELY NO WARRANTY.\n"  \
    "You may redistribute this software under certain conditions;\n"        \
    "read the file LICENSE.TXT for details. Run 'xilite -h' for help.\n"
