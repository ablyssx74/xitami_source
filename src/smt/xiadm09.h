...
static byte xiadm09_blocks [] = {
    ...
    0, 41, 0, '<', 'P', '>', 'M', 'I', 'M', 'E', 32, 't', 'y', 'p', 'e',
    's', 32, '(', 's', 'h', 'o', 'w', 'i', 'n', 'g', 32, 'b', 'u', 'i',
    'l', 't', 45, 'i', 'n', 32, 't', 'y', 'p', 'e', 's', ')', ':', 10,
    ...
    0, 29, 10, 6, 1, 0, 0, 15, 0, 15, 'f', '1', '4', '1', 0, 'F', 'i',
    ...
    0, 24, 10, 6, 1, 0, 0, 10, 0, 10, 'f', '1', '4', '2', 0, 'M', 'I',
    'M', 'E', 32, 't', 'y', 'p', 'e', ':', 0,
    /*  </TH>                                                                */
    0, 4, 1, 0, 8, 201,
    /*  !--REPEAT mime_list  ROWS=15                                         */
    0, 7, 4, 0, 6, 0, 12, 0, 15,
    /*  </TR>                                                                */
    0, 7, 0, '<', '/', 'T', 'R', '>', 10,
    /*  <TR>                                                                 */
    ...
    10,
    /*  !--FIELD TEXTUAL f143 NAME=key SIZE=10 MAX=? UPPER=0 VALUE=""        */
    0, 14, 10, 4, 15, 0, 0, 10, 0, 10, 'f', '1', '4', '3', 0, 0,
    /*  </TD>                                                                */
    0, 7, 0, '<', '/', 'T', 'D', '>', 10,
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 9, 16,
    /*  !--FIELD TEXTUAL f144 NAME=m ... E=10 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, 10, 0, 10, 'f', '1', '4', '4', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, '>',
    /*  <TD ALIGN=LEFT VALIGN=TOP>                                           */
    0, 4, 1, 0, 9, 16,
    /*  !--FIELD TEXTUAL f145 NAME=m ... E=50 MAX=? UPPER=0 VALUE=""         */
    0, 14, 10, 0, 15, 0, 0, '2', 0, '2', 'f', '1', '4', '5', 0, 0,
    /*  </TD>                                                                */
    0, 4, 1, 0, 9, '>',
    /*  </TR>                                                                */
    0, 4, 1, 0, 9, 1,
    /*  </TABLE>                                                             */
    0, 4, 1, 0, 7, 15,
    /*  !--FIELD NUMERIC mime_list SIZE=4 VALUE=15                           */
...
static FIELD_DEFN xiadm09_fields [] = {
    { 0, 1905, 80 },                    /*  message_to_user                 */
    { 82, 2218, 15 },                   /*  l_mime_ext                      */
    { 99, 2264, 10 },                   /*  l_mime_type                     */
    { 111, 2350, 10 },                  /*  key                             */
    { 291, 2381, 10 },                  /*  mime_ext                        */
    { 471, 2409, 50 },                  /*  mime_type                       */
    { 1251, 2443, 4 },                  /*  mime_list                       */
    { 1257, 0, 0 },                     /*  -- sentinel --                  */
    };
...
typedef struct {
    ...
    char   key                  [15] [10 + 1];
    byte   mime_ext_a           [15] ;
    char   mime_ext             [15] [10 + 1];
    byte   mime_type_a          [15] ;
    char   mime_type            [15] [50 + 1];
    byte   mime_list_a          ;
    char   mime_list            [4 + 1];
    byte   back_a;
    byte   save_a;
